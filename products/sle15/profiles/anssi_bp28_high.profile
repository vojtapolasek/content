...
description: |-
    This profile contains configurations that align to ANSSI-BP-028 v2.0 at the high hardening
    level.

    ANSSI is the French National Information Security Agency, and stands for Agence nationale de
    ...
    Only the components strictly necessary to the service provided by the system should be
    installed.
